...
**Project**: site-synonym-sculptor 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**:  make an exact replica of this site 
...
```sh
git clone https://github.com/GPT-Engineer-App/site-synonym-sculptor.git
cd site-synonym-sculptor
npm i
